...
def Intro():
	print("")
	print("In this adventure, you are hero")
	...
	print("Will you succeed to free your friends from the castle dungens, or perill trying?")
	print("")
...
def create_character():
	...
	character_name = input("""
		Let's begin by creating your chracter.
		What is yourv chracter name ?

		> """)
	global character_race
	while character_race is None:
		race_choice = input("""
		Choose your cahracter race form the list below by entring the relevant number 
		1- Elf
		2- Dwarf
	...
	while character_class is None:
		class_choice = input("""
		Choose your cahracter class form the list below by entring the relevant number 
		1- Warrior
		2- Wizard
...
def create_character_skill_sheet():
	...
	print("""
	Now lets determine your character's skills, which you will use throughout the game.
	...
	- Magic, which you will use whenever you need to cast e spell or use/inspect a magical item or place 
	- LIfe, which determines your life energy, points will be lost when hurt,
	  and whenever life reaches 0, your chracter dies.
