...
<link rel="stylesheet" href="css/worldpeace.css?v=5">
...
<p><code class="copyright-text">Inventory</code></p>
...
$sql = "SELECT merchandise_item_id, description, unit_price, qoh FROM merchandise_item";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
  // output data of each row

  echo "<table><thead><tr><th>Item ID</th><th>Description</th><th>Unit Price</th><th>Qty On Hand</th></tr></thead>";

  echo "<tbody>";

  while($row = $result->fetch_assoc()) {
    echo "<tr>";
    echo "<td>".$row["merchandise_item_id"]."</td><td>".$row["description"]."</td><td>$".number_format($row["unit_price"]/100.0, 2)."</td><td>".$row["qoh"]."</td>";
    echo "</tr>";
  }
